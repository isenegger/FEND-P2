...
var HTMLschoolMajors = '<em><br>Major(s): %data%</em>';
...
/*
This is jQuery code.
The function click() adds an event listener to the document object.
*/
  ...
  */
  function createMapMarker(placeData) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      // For learning purposes: an info window can also be located like this:
      // var pos = new google.maps.LatLng(lat, lon);
      // infoWindow.setPosition(pos);

      // However, it it possible to attach it directly to a marker.
